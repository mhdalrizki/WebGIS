        ...
        <div class="row h-100">
            <div class="col-lg-5 col-12">
                <div id="auth-left">
                    <div class="auth-logo">
                        <a href="/">
                            <h3>WebGIS Pemetaan Penduduk</h3>
                        </a>
                    </div>
                    <h1 class="auth-title">Desa Geneng</h1>
                    <p class="auth-subtitle mb-5">Silahkan masuk menggunakan akun yang telah dibuat.</p>

                    <form action="<?= site_url('auth/login') ?>" method="POST">
                        <div class="form-group position-relative has-icon-left mb-4">
                            <input type="text" class="form-control form-control-xl" name="username" placeholder="Nama Pengguna">
                    ...
                    <div class="text-center mt-5 text-lg fs-4">
                        <p class="text-gray-600">Belum Punya Akun? <a href="/auth/registrasi" class="font-bold">Daftar</a>.</p>
