        ...
        <div class="row h-100">
            <div class="col-lg-5 col-12">
                <div id="auth-left">
                    ...
                    <p class="auth-subtitle mb-5">Registrasi akun WebGIS pemetaan penduduk desa Geneng.</p>
                    ...
                    <div class="text-center mt-3 text-lg fs-4">
                        <p class="text-gray-600">Sudah Punya Akun? <a href="/auth" class="font-bold">Masuk</a>.</p>
